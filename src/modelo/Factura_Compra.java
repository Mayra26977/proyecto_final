...
public class Factura_Compra {
    ...
    public Factura_Compra(boolean eliminado, Date fecha, Date fecha_aniade, Date fecha_borra, Date fecha_mod, int usuario_aniade, int usuario_borra, int usuario_mod, int id_factura, int id_pedido) {
