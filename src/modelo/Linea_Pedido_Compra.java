 ...
 * @author Mayra
 */
public class Linea_Pedido_Compra {
    ...
    public Linea_Pedido_Compra() {
    }

    public Linea_Pedido_Compra(int idLinea_pedido, int id_pedido, int id_producto, double cantidad, double importe_total_linea) {
